...
<section className="mx-auto mt-16 mb-20 max-w-6xl rounded-3xl border border-blue-500 bg-slate-900 p-10 text-center">
  ...
  <h2 className="text-3xl font-bold">
    Ready to Generate CI/CD Pipelines?
  </h2>

  <p className="mt-5 text-slate-400">
    Launch the CI/CD Expert to generate automated build, test, deployment,
    and release pipeline configurations for modern applications.
  </p>
