...
<section className="mx-auto mt-16 mb-20 max-w-6xl rounded-3xl border border-blue-500 bg-slate-900 p-10 text-center">
  ...
  <h2 className="text-3xl font-bold">
    Ready to Generate Terraform Files?
  </h2>

  <p className="mt-5 text-slate-400">
    Launch the Terraform Expert to generate Infrastructure as Code (IaC)
    templates for AWS, Azure, and GCP instantly.
  </p>
