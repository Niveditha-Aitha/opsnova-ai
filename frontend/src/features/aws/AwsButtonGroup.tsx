...
function AwsButtonGroup({
  ...
  const handleDownloadAll = async () => {
    ...
    zip.file("cloudformation.yaml", cloudformation);
    zip.file("aws-cli.sh", awsCli);
    zip.file("iam-policy.json", iamPolicy);
    ...
    const a = document.createElement("a");
    a.href = url;
    a.download = "aws-project.zip";

    a.click();

    window.URL.revokeObjectURL(url);

    toast.success("AWS project downloaded!");
  };
